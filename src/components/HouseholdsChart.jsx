    ...
    <section className="section supporting-section">
      <details className="supporting-disclosure">
        <summary>
          ...
          <span className="disclosure-title">Where the households went</span>
          <span className="disclosure-summary">
            Lewisham gained <strong>{signed(HEADLINE.change.households)}</strong> households,
            but growth varied across its {areas.length} comparable areas. Explore the full
            area-level household chart alongside overcrowding count and rate context.
          </span>
          <span className="disclosure-action">Explore household change</span>
        </summary>

        <div className="disclosure-content">
          <p className="section-lede">
            {gainedLost.gained} of the {areas.length} areas gained households and{' '}
            {gainedLost.lost} lost them. Over the same decade the number of overcrowded
            households fell by just {Math.abs(HEADLINE.change.overcrowded)} — it rose in{' '}
            {gainedLost.ocRose} areas and fell in {gainedLost.ocFell}. These area-level
            changes describe where counts changed; they cannot track individual households.
          </p>
